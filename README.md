...
* **DFT bands / stacks:** Auto k-path is the **loaded cell’s BZ** (folded for twisted/large supercells). Optional **primitive hex reference** walks graphene-like Γ–K–M in Å⁻¹ then folds into the supercell (educational; not ARPES spectral-weight unfolding).
