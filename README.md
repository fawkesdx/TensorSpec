...
* **Suite Panels:** Crystal, DFT, and ARPES suites are live end-to-end (HTML → API → `core/`). PEEM load+view supports TIF stacks/folder sequences, companion CSV metadata, and interactive frame/contrast controls; PEEM analysis and XAS / Transport / ML engines remain pending.
